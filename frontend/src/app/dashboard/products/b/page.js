  ...
  return (
    <>
      ...
      <div className="h-screen bg-gray-50 dark:bg-gray-900">
        <div className="p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Production Line B</h2>
            <p className="text-gray-600 dark:text-gray-400">Total Orders of Product B</p>
            <div className="mt-2">
