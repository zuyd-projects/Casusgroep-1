...
export default function OrderDetail({ params }) {
  ...
  // Determine back link and text based on returnTo parameter
  const getBackNavigation = () => {
    switch (returnTo) {
      case "voorraadBeheer":
        return {
          href: "/dashboard/voorraadBeheer",
          text: "← Back to Voorraad Beheer",
        };
      default:
        return {
  ...
  useEffect(() => {
    const fetchOrder = async () => {
      try {
        ...
        if (orderData) {
          console.log(
            "[Order Detail] Successfully fetched order data:",
            orderData
          );
          setOrder(orderData);
  ...
  const updateStatus = async (newStatus) => {
    try {
      ...
      try {
        ...
        console.warn(
          "[Order Detail] API status update not supported, updating locally:",
          apiError.message
        );
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-800">
            Print Invoice
          </button>
          ...
          <Card title="Order Status">
            <div className="mb-4">
              ...
              >
                ...
                <option value="RejectedByVoorraadbeheer">
                  Rejected by Voorraadbeheer
                </option>
