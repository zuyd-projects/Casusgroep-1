      ...
      <div className="h-screen bg-gray-50 dark:bg-gray-900">
        <div className="p-6">
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Production Line 1</h2>
            </div>
            <p className="text-gray-600 dark:text-gray-400">Orders assigned to Production Line 1</p>
            <div className="flex items-center gap-4 mt-4">
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center px-4 py-2 rounded-lg bg-blue-600 text-white text-base font-semibold dark:bg-blue-700">
          ...
          <div className="grid grid-cols-2 gap-6 h-full">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-bold text-blue-700 dark:text-blue-400">Assigned Orders</h3>
              </div>
        ...
        {lastRemovedOrder && (
          <div className="fixed bottom-6 right-6 z-50">
            <button
              className="px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded-lg shadow-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
