        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rounds_Simulations_SimulationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryRate = table.Column<float>(type: "real", nullable: false),
                    Revenue = table.Column<float>(type: "real", nullable: false),
                    Cost = table.Column<float>(type: "real", nullable: false),
                    NetProfit = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Statistics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Statistics_Simulations_SimulationId",
                        column: x => x.SimulationId,
                        principalTable: "Simulations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Materials_SupplierOrders_SupplierOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_SupplierOrderId",
                table: "Materials",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rounds_SimulationId",
                table: "Rounds",
                column: "SimulationId");

            migrationBuilder.CreateIndex(
                name: "IX_Statistics_SimulationId",
                table: "Statistics",
                column: "SimulationId");
