...
namespace ERPNumber1.Interfaces
{
    public interface IEventLogService
    {
        ...
        /// </summary>
        Task<object> GetSimulationBusinessAnalysisAsync(DateTime? startDate = null, DateTime? endDate = null);

        /// <summary>
        /// Get simulation performance metrics for the dashboard
        /// </summary>
        Task<object> GetSimulationPerformanceAsync(DateTime? startDate = null, DateTime? endDate = null);
    }
}
